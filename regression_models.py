...
def lr_graph():
    ...
    for i in range (21):
        lr_result.append([i, ridge_regression(x_train, x_test, y_train, y_test, i)[1], lasso_regresion(x_train, x_test, y_train, y_test, i)[1]])
...
def knr_graph():
    ...
    for i in range (1,51):
        knr_result.append([i, k_neightbor_regression_unweighted(x_train, x_test, y_train, y_test, i)[1], k_neightbor_regression_weighted(x_train, x_test, y_train, y_test, i)[1]])
...
def rfr_graph():
    ...
    for i in range (2,101):
        rfr_result.append([i, random_forest_regression(x_train, x_test, y_train, y_test, i)[1]])
